# General utilities
sudo apt-get install terminator git deluge curl gparted python3-pip python3-dev okular vlc filezilla vokoscreen tree gimp docker.io htop mediainfo handbrake \

# Echoing programs that aren't available in aptitude and i should not forget to install
echo "\nDon't forget to install: Postman, Telegram, URSim \n"
